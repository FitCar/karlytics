...
const CarCard = ({ car_details }) => {
  ...
  const checkServiceDate = () => {
    if (
      new Date(car_details.nextServiceDate).getTime() >
  ...
  return (
    <TouchableOpacity
      style={tw`bg-white items-center mb-8 rounded-3xl mx-10 py-5 pl-5 shadow-xl`}
