...
const ServiceInfo = ({ serviceDate, duration, progressLeft }) => {
  ...
  return (
    <View>
      <Text style={tw`ml-10 font-bold`}>Car Servicing</Text>
      <View style={tw`flex-row justify-between`}>
      <Text style={tw`ml-10 font-bold`}>Due by {serviceDate}</Text>
      <Text style={tw`mr-10 font-bold`}>{duration} left</Text>
      </View>
