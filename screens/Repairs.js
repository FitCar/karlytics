...
const Repairs = () => {
  ...
  return (
    <View style={tw`bg-white`}>
      ...
      <View>
        <CollapsibleView style={tw`mb-8 rounded`} title="select a car">
          <TouchableOpacity>
            <Text>Option2</Text>
          </TouchableOpacity>
          <TouchableOpacity>
        ...
        <View
          style={tw`mb-8 flex-row justify-around h-20 items-center shadow-md border-0 rounded`}
        >
          <TouchableOpacity>
        ...
        <CollapsibleView style={tw`mb-8 rounded`} title="select location">
          <TouchableOpacity>
            <Text>Option2</Text>
          </TouchableOpacity>
          <TouchableOpacity>
        ...
        <CollapsibleView style={tw`mb-8 rounded`} title="select date">
          <TouchableOpacity>
            <Text>Option2</Text>
          </TouchableOpacity>
          <TouchableOpacity>
        ...
        <CollapsibleView style={tw`mb-8 rounded`} title="select time">
          <TouchableOpacity>
            <Text>Option2</Text>
          </TouchableOpacity>
          <TouchableOpacity>
